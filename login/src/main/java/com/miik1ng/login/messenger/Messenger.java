...
public class Messenger {
     ...
     * @param iCallbackNop do something on message received
     */
    public void register(Object recipient, ICallbackNop iCallbackNop) {
        register(recipient, null, false, iCallbackNop);
    }
     ...
     * @param iCallbackNop                 do something on message received
     */
    public void register(Object recipient, boolean receiveDerivedMessagesToo, ICallbackNop iCallbackNop) {
        register(recipient, null, receiveDerivedMessagesToo, iCallbackNop);
    }
     ...
     * @param iCallbackNop do something on message received
     */
    public void register(Object recipient, Object token, ICallbackNop iCallbackNop) {
        register(recipient, token, false, iCallbackNop);
    }
     ...
     * @param iCallbackNop                 do something on message received
     */
    public void register(Object recipient, Object token, boolean receiveDerivedMessagesToo, ICallbackNop iCallbackNop) {
        ...
        WeakAction weakAction = new WeakAction(recipient, iCallbackNop);
     ...
     * @param iCallback    this action has one params that type of tClass
     * @param <T>       message data type
     */
    public <T> void register(Object recipient, Class<T> tClass, ICallback<T> iCallback) {
        register(recipient, null, false, iCallback, tClass);
    }
     ...
     * @param <T>                       message data type
     */
    public <T> void register(Object recipient, boolean receiveDerivedMessagesToo, Class<T> tClass, ICallback<T> iCallback) {
        register(recipient, null, receiveDerivedMessagesToo, iCallback, tClass);
    }
     ...
     * @param <T>       message data type
     */
    public <T> void register(Object recipient, Object token, Class<T> tClass, ICallback<T> iCallback) {
        register(recipient, token, false, iCallback, tClass);
    }
     ...
     * @param <T>                       message data type
     */
    public <T> void register(Object recipient, Object token, boolean receiveDerivedMessagesToo, ICallback<T> iCallback, Class<T> tClass) {
        ...
        WeakAction weakAction = new WeakAction<T>(recipient, iCallback);
        ...
        synchronized (lists) {
            for (WeakActionAndToken item : lists.get(messageType)) {
                ...
                if (weakActionCasted != null
                        ...
                        && (iCallback == null
                        || iCallback == weakActionCasted.getICallback())) {
        ...
        synchronized (lists) {
            for (WeakActionAndToken item : lists.get(messageType)) {
                ...
                if (weakActionCasted != null
                        && recipient == weakActionCasted.getTarget()
                        && (iCallbackNop == null
                        || iCallbackNop == weakActionCasted.getICallbackNop())) {
                    item.getAction().markForDeletion();
                }
            }
        }
        ...
        synchronized (lists) {
            for (WeakActionAndToken item : lists.get(messageType)) {
                ...
                if (weakActionCasted != null
                        && recipient == weakActionCasted.getTarget()
                        && (action == null
                        || action == weakActionCasted.getICallback())
                        && (token == null
        ...
        synchronized (lists) {
            for (WeakActionAndToken item : lists.get(messageType)) {
                ...
                if (weakActionCasted != null
                        && recipient == weakActionCasted.getTarget()
                        && (action == null
                        || action == weakActionCasted.getICallbackNop())
                        && (token == null
                        || token.equals(item.getToken()))) {
                    item.getAction().markForDeletion();
                }
